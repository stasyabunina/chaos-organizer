...
export default class VideoController {
	...
	render() {
		...
		videoWrapper.className =
			"fullscreen:border-0 fullscreen:max-w-none fullscreen:w-full";
		...
		videoControls.className =
			"w-full h-0 px-2 flex justify-center items-center bg-neutral bg-opacity-80 transition-[height] ease-out duration-100 overflow-hidden";
		...
		slider.value = 0;
		slider.className =
			"video-slider w-[99.9%] bg-[#e5e7eb] outline-none h-[5.5px] appearance-none cursor-pointer focus-visible:outline-none";
		...
		volumeSlider.className =
			"volume-slider mr-auto bg-[#FF79C6] outline-none h-[5.5px] appearance-none cursor-pointer focus-visible:outline-none";
	...
	volumeHandler() {
		...
		this.volumeBtn.addEventListener("click", () => {
			if (this.video.volume !== 0) {
				...
				this.volumeSlider.style.background = `linear-gradient(to right, #FF79C6 ${
					this.volume * 100
